...
Dados $n$ pares de puntos $(x_1,y_1), \dots, (x_n, y_n)$, el polinomio interpolador de Lagrange, es decir el único polinomio $f(x)$ de grado $k+1$ tal que $f(x_i)=y_i$ para todo $i=1,\dots,n$. Su expresión viene dada por:
